...
- [x] 1. Estructura base del proyecto y configuración de tests
...
- [x] 2. GameState y carga de assets
...
- [x] 3. PhysicsEngine — gravedad, flap y posición
  ...
  - [x] 3.1 Test unitario: Ghosty inicia en posición central al resetear
    - Verificar que tras reset `ghosty.y === 320` y `ghosty.vy === 0`
    - _Requirements: 7.3_

  - [x] 3.2 Property test — Property 1: La física aplica gravedad con clamp correcto
  ...
  - [x] 3.3 Property test — Property 2: El flap establece velocidad ascendente fija
  ...
  - [x] 3.4 Property test — Property 3: La posición se actualiza correctamente cada frame
